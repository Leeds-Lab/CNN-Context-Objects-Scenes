...
def sort_numbered_file_names(list_of_paths, num_of_files):
        paths_for_analysis = [file_name for file_name in list_of_paths if "DS_Store" not in file_name]
...
def organize_paths_for(directories, max_files):
        ...
        for path in directories:
                ...
                sorted_pic_list = sort_numbered_file_names(
                        [file_name for file_name in listdir(path) if "DS_Store" not in file_name], 
                        max_files
