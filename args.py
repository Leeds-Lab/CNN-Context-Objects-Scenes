...
def parser_cmds():
    ...
    all_args.add_argument("-c", "--compute_ratios", default=0, help="calculate context and category ratios for each cnn model network using matrix data created from --net_responses")
